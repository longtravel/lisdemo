...
public class LisdemoTestContainer extends TestContainer {

    public LisdemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/lisdemo/app.properties",
    ...
    public static class Common extends LisdemoTestContainer {

        public static final LisdemoTestContainer.Common INSTANCE = new LisdemoTestContainer.Common();
